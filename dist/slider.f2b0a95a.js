...
})({"kI94U":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d7e94276f2b0a95a";
"use strict";
...
},{}],"fbSLs":[function(require,module,exports,__globalThis) {
'use strict';
...
function moveSlide() {
    ...
    paginationItems.forEach((item, index)=>{
        if (index === currentSlide) item.classList.add('pagination__item--active');
        else item.classList.remove('pagination__item--active');
    });
}
...
},{}]},["kI94U","fbSLs"], "fbSLs", "parcelRequire69db", {})

//# sourceMappingURL=slider.f2b0a95a.js.map
